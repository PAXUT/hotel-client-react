  ...
  return (
    <div className="container-fluid mt-5 col-lg-10">
      <div className="row g-5 mt-5">
        <section className="mb-4 col-lg-8 row d-none d-md-flex">
      <Back />
          <h4 className="mb-3 text-center mb-5">Thông tin phòng</h4>
          ...
          <div className="col-lg-7">
            ...
            {room?.convenients && room?.convenients.length > 0 ? (
              ...
              <p className="text-muted">Không có tiện nghi nào được liệt kê.</p>
            )}
          </div>
        </section>

        <section className="mb-4 col-lg-4 border border-info rounded p-4">
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <h2 className="mb-3">Chi tiết hóa đơn</h2>
              <div className="mb-3">
                <u>
                  <div className="row">
              ...
              />
              {numberOfDays ? (
                <div className="col-auto text-danger">{numberOfDays} ngày</div>
              ) : (
